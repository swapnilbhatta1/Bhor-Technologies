...
export const metadata = {
  title: "Enterprise | Bhor Technologies",
  description: "Enterprise solutions by Bhor Technologies. Innovate, automate, and secure the future of your business together.",
};
  ...
  return (
    <ConsultationProvider>
      <div className="relative overflow-x-clip bg-slate-950 text-slate-50 font-sans selection:bg-red-500/30 selection:text-red-200 min-h-screen flex flex-col">
        ...
        {/* Deep, rich dark background with subtle red aura */}
        <div className="absolute top-0 inset-x-0 h-[800px] overflow-hidden -z-10 pointer-events-none">
          <div className="absolute top-[-20%] left-[-10%] w-[60%] h-[80%] rounded-full bg-red-900/20 blur-[120px]" />
          <div className="absolute top-[20%] right-[-10%] w-[50%] h-[60%] rounded-full bg-red-900/10 blur-[100px]" />
        </div>
          ...
          <Container>
            <div className="grid grid-cols-1 gap-16 lg:grid-cols-[0.8fr_1.2fr] lg:items-center lg:gap-24">
              ...
              <div className="relative order-2 lg:order-1 flex justify-center lg:justify-start">
                ...
                <div className="absolute -inset-4 -z-10 rounded-[3rem] bg-gradient-to-br from-red-600/20 to-transparent blur-2xl opacity-70 group-hover:opacity-100 transition-opacity duration-700 max-w-[420px]" />
              </div>
              ...
              <div className="flex flex-col gap-8 order-1 lg:order-2">
                ...
                <div className="prose prose-invert prose-lg md:prose-xl text-slate-300 max-w-none">
                  <p className="leading-relaxed font-light">
                    At <strong className="font-semibold text-white">Bhor Technologies</strong>, the word &apos;Bhor&apos; signifies a new dawn—a fresh start driven by innovation. As the CEO, my core vision is to bridge the gap between complex technology and real-world business growth.
                  </p>
                  
                  <p className="leading-relaxed font-light mt-6 sm:mt-8">
                    We don&apos;t just write code or build websites; we design <span className="text-red-400 font-medium">intelligent ecosystems</span>. By combining AI automation, scalable software, and ironclad cybersecurity, our goal is to help you save time, reduce costs, and scale faster. Your success is the metric we measure our performance by.
                  </p>
                  
                  <blockquote className="mt-10 sm:mt-12 text-xl sm:text-[1.35rem] font-medium text-white italic border-l-4 border-red-500 pl-6 py-2 leading-snug">
