  ...
  },
  {
    ...
    logo: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-10 h-10">
        <path fillRule="evenodd" clipRule="evenodd" d="M17.5 4.5c-2.4 0-4.5 1.4-5.5 3.5-1-2.1-3.1-3.5-5.5-3.5-3.6 0-6.5 2.9-6.5 6.5s2.9 6.5 6.5 6.5c2.4 0 4.5-1.4 5.5-3.5 1 2.1 3.1 3.5 5.5 3.5 3.6 0 6.5-2.9 6.5-6.5s-2.9-6.5-6.5-6.5zM6.5 14.5c-1.9 0-3.5-1.6-3.5-3.5s1.6-3.5 3.5-3.5 3.5 1.6 3.5 3.5-1.6 3.5-3.5 3.5zm11 0c-1.9 0-3.5-1.6-3.5-3.5s1.6-3.5 3.5-3.5 3.5 1.6 3.5 3.5-1.6 3.5-3.5 3.5z" />
      </svg>
    ),
  },
  {
